...
BODY = bytes.fromhex(
    "8b55f08b4df083c20483c1088b45f0d900d808d902d80adec1d901d809dec1d95dec33c933d233c0c3"
)
REGION = (0, 31)
SWAP = [6, 9]
    ...
    moved = [
        {
            **item,
            ...
            "swap_offsets": [offset + 1 for offset in item["swap_offsets"]],
        }
        for item in items
    ]
...
class ExchangeTests(unittest.TestCase):
    def test_the_exchange_swaps_the_two_immediates_and_nothing_else(self):
        ...
        self.assertEqual(proof["exchanges"][0]["dead_registers"], ["ecx", "edx"])
    ...
    def test_an_instruction_outside_the_simulator_set_is_refused(self):
        ...
        self.assertIn("outside the simulator's closed set", str(raised.exception))
