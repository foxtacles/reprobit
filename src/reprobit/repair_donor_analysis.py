...
from reprobit.classic_orchestration import canonical_overlay_operations
...
def probe_classic_donor_repairs(
    ...
    if not refusals:
        return ClassicDonorRetuneProbeResult((), (), 0, False)
        ...
        try:
            ...
            if prepared.producer.is_open:
                try:
                    ...
                    original.add_note(
                        f"classic donor repair cleanup also failed: {cleanup_error}"
                    )
            raise
