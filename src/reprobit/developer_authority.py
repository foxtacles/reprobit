"""Invocation-local source authority shared by cold and cached developer builds.

This module validates source edits without opening the incremental cache or
changing committed source, build-plan, intervention, or proof documents.
"""
